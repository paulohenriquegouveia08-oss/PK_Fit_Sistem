 ...
 */
export async function getStats(academyId) {
 ...
 */
export async function listUsers(academyId, filters = {}) {
...
/**
 * Cria usuário na academia
 */
export async function createUser(academyId, data) {
 ...
 */
export async function updateUser(academyId, userId, data) {
 ...
 */
export async function deleteUser(academyId, userId) {
    const user = await prisma.user.findFirst({
        where: { id: userId, academy_id: academyId }
    });
 ...
 */
export async function listWorkouts(academyId, filters = {}) {
 ...
 * Cria treino
 */
export async function createWorkout(academyId, data) {
 ...
 * Atualiza treino
 */
export async function updateWorkout(academyId, workoutId, data) {
 ...
 * Remove treino
 */
export async function deleteWorkout(academyId, workoutId) {
    const workout = await prisma.workout.findFirst({
        where: { id: workoutId, academy_id: academyId }
    });
 ...
 */
export async function listRequests(academyId, filters = {}) {
 ...
 */
export async function processRequest(academyId, requestId, action) {
 ...
 */
export async function getAcademy(academyId) {
 ...
 */
export async function updateAcademy(academyId, data) {
 ...
 */
export async function getRecentActivity(academyId, limit = 10) {
...
/**
 * Lista professores da academia
 */
export async function listProfessors(academyId) {
    return prisma.user.findMany({
        where: {
            academy_id: academyId,
            role: { in: ['PROFESSOR', 'PERSONAL'] },
