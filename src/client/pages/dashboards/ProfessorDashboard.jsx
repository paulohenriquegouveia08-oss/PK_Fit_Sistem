        ...
        <div className="dashboard-layout">
            <header className="dashboard-header">
                <div className="dashboard-header-left">
                    ...
                    <nav className="dashboard-header-nav">
                        ...
                        <a href="#" className="dashboard-nav-link">Meus Alunos</a>
                        <a href="#" className="dashboard-nav-link">Treinos</a>
            ...
            <main className="dashboard-main">
                ...
                <p className="dashboard-subtitle">
                    Acompanhe seus alunos e gerencie os treinos.
                </p>
                ...
                <div className="stats-grid">
                    <div className="stat-card">
                        ...
                        <div className="stat-card-label">Alunos Atribuídos</div>
                    </div>
                    ...
                    <div className="stat-card">
                        ...
                        <div className="stat-card-label">Treinos Hoje</div>
                    </div>
                ...
                <div className="content-card">
                    <div className="content-card-header">
                        <h3 className="content-card-title">Próximos Atendimentos</h3>
                        <button className="btn btn-primary">+ Novo Treino</button>
                    </div>
                    <div className="empty-state">
                        <div className="empty-state-icon">📅</div>
                        <p className="empty-state-title">Funcionalidade em desenvolvimento</p>
                        <p>Sua agenda de atendimentos será exibida aqui.</p>
                    </div>
                </div>
            </main>
        </div>
